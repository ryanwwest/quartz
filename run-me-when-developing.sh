#set -x
#watch -n 5 
bash -c 'rm -rf ~/g/quartz/content/* ~/g/quartz/public/* && python3 obsidian-to-quartz.py ~/g/zk/media/ ~/g/zk/blog/ ~/g/quartz/content/media/ ~/g/quartz/content/ && hugo-obsidian -input=content -output=assets/indices -index=true -root=. && hugo'
